        ...
        <div className={styles.catalog}>
            <div className={styles.catalog_container} ref={catalogRef}>
                ...
                <div className={styles.catalog_section}>
                    ...
                    <p className={styles.catalog_desc}>ниже представлены модели лодок, которые прошли все необходимые сертификации и готовы к продаже прямо сейчас</p>
                ...
                <div className={styles.catalog_section}>
                    ...
                    <p className={styles.catalog_desc}>ниже представлены модели лодок, которые в данный момент находятся в процессе прохождения необходимых сертификаций и будут доступны для продажи в ближайшее время</p>
                    <div className={styles.catalog_menu}>
                        <ul>
                            {futureModelsItems}
                        </ul>
